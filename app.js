...
app.post('/register', (req, res) => {
    ...
    session
        .run('CREATE (a:Person {firstname: {fParam}, lastname: {lParam}}), (b:Email {value: {emParam}}), (c:Phone {value: {phParam}}), (a)-[]->(b)', {fParam: fname, lParam: lname, emParam: email, phParam: phone})
        .then()
        .catch();
});
